...
class Controller(object):
    def __init__(self, vehicle_mass, decel_limit, accel_limit, wheel_radius, wheel_base,
        ...
        self.velocity_pid = PID(0.2, 0.004, 3, mn = decel_limit, mx = 0.2)
        self.steer_pid = PID(0.1, 0.004, 3, mn = -max_steer_angle, mx = max_steer_angle)
    ...
    def control(self, twist, velocity, time_diff):
        ...
        steer = self.yawController.get_steering(twist.twist.linear.x, twist.twist.angular.z, velocity.twist.linear.x)
